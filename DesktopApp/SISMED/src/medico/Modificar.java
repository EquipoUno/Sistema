...
public class Modificar extends JFrame{
    ...
    private JButton regresar, buscar, modificar;
    ...
    public void initPanel(){
        ...
        buscar.addActionListener( new ActionListener(){
            ...
            public void actionPerformed( ActionEvent ae ){
                //realizar consulta y mostrar la info en los campos
                limpiarCampos();
        ...
        buscar.setBounds( 360, 15, 100, 20 );
        modificar.setBounds( 700, 440, 100, 40 );
        regresar.setBounds( 700, 490, 100, 40 );
        ...
        /*MouseListener[] ml = (MouseListener[])presion_alta.getListeners(MouseListener.class);
        MouseListener[] ml2 = (MouseListener[])diabetes.getListeners(MouseListener.class);
        MouseListener[] ml3 = (MouseListener[])cancer.getListeners(MouseListener.class);
        MouseListener[] ml4 = (MouseListener[])enf_cardiaca.getListeners(MouseListener.class);
        for (int i = 0; i < ml.length; i++){
            presion_alta.removeMouseListener( ml[i] );
            diabetes.removeMouseListener( ml2[i] );
            cancer.removeMouseListener( ml3[i] );
            enf_cardiaca.removeMouseListener( ml4[i] );
        }*/
        //alergias.setEditable( false );
        cirugias_anteriores.setEditable( false );
        fecha_act.setEditable( false );
        //notas.setEditable( false );
        /*nombre.setEditable( false );
        direccion.setEditable( false );
        email.setEditable( false );
        telefono.setEditable( false );*/
        unidad_medica.setEditable( false );
        fecha_nac.setEditable( false );
        no_social.setEditable( false );
        /*nombre_rep.setEditable( false );
        direccion_rep.setEditable( false );
        email_rep.setEditable( false );
        telefono_rep.setEditable( false );*/
